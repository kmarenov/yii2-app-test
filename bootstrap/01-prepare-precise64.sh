...
apt-get install -y apache2 php5 vim mysql-client mysql-server php5-mysqlnd git php5-curl php5-mcrypt php5-intl php5-memcache php5-sqlite php5-pgsql php-apc php5-gd php5-imagick
